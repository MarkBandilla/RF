...
var rfMigrateSQLSchema = [
	{
		...
		method: 'createColumn',
		column: [
			{ type: 'string', name: 'fullname', seed: 'fullname', order: 1,
				params: {
					label: 'String',
			...
			{ type: 'string', name: 'avatar', seed: 'avatar', order: 5,
				params: {
					label: 'Avatar',
					placeholder: '',
					default: '',
		...
		up: [
			'ALTER TABLE rf_input_types ADD fullname VARCHAR(100)',
		...
		down: [
			'ALTER TABLE rf_input_types DROP fullname',
